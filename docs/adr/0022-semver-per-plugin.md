...
**Status:** Accepted (2025-04); `0.x` semantics amended 2026-08, see [Amendment](#amendment-2026-08)
...
**for a plugin at `1.0.0` or above** — see [Amendment](#amendment-2026-08) for a `0.x` plugin:
...
**What a `0.x` version means (#391).** Three of the six plugins were on a `0.x` line when this was
written — `auto-format`, `unic-archon-dlc`, `unic-spec-review`. Read literally, the table in § Decision
makes the next breaking change to any of them a `1.0.0`. That is neither what has happened nor what
should: ten breaking releases of `unic-archon-dlc` shipped as minor bumps (0.2.0, 0.3.0, 0.4.0, 0.5.0,
0.6.0, 0.11.0, 0.15.0, 0.16.0, 0.19.0, 0.22.0).
...
**So the § Decision table governs a plugin at `1.0.0` or above.** Below `1.0.0`:
