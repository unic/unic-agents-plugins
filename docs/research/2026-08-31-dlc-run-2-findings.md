...
| 24  | `classesAtRest` and `expectNoCardBranch` read class attributes.                                                | Same drawer as 23.                                                                                                                                                                                                                                   |
...
Chosen 2026-09-01 by comparing both Storybooks side by side, 6006 against 6007. **Open sub-question:**
`card-with-badge` is the composition demo, not a component; whether it sits under `COMPONENTS` or gets
its own section is undecided.
