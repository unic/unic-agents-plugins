...
| #   | Finding                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            | Evidence                                                                                                                          |
| --- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------- |
| 35  | **CORRECTED 2026-09-03 — the row as first written was false.** The thirteen findings WERE recorded: `unic-dlc-build.yaml:578` has the `report` node fold `$implement-review-precheck.output.findings` in verbatim, and run 2's `open-pr` committed them in `workflows/profile-card/report.md` § 4 "Local code-review pre-check" (`c66eac9` on `feature/43004_build-profile-card`, 18:07 UTC, reviewable on PR 5825 throughout). What seeded the error: `$ARTIFACTS_DIR` was empty, correctly, because `evidence` withheld on the red verdict, and that was read as "no file carried the output" without opening the committed one. What survives, smaller: the findings have one carrier (the event row) until `report` runs four nodes later, so a node error in `evidence`/`verification`/`goals-check` drops them with no trace outside SQLite; and the dispatch log shows two lines for a node that found thirteen problems. Found by `DLC-438-grilling`, verified from the orchestrator seat. | **#438 closed 2026-09-03 as not a defect**; the `/qa` orphans are **#458**                                                        |
...
| **35** thirteen precheck findings | ~~nowhere a human or the report can reach~~ — **corrected 2026-09-03**: in `report.md` § 4 on the PR branch, via `unic-dlc-build.yaml:578` | The record reaches the report. What does not exist is any carrier between the node and `report`, four nodes later; see row 35.                                                                                                                                                                                                                                                                     |
...
**Answered.** The five rules the six checks enforce were honoured by an implementer who violated three of them in
run 2 with the same criteria in front of it. The checks fired on nothing in GREEN because there was nothing to fire
