---
title: Fix warnings in CI after merging a branch
created: 2026-05-03
---

Fix warnings in CI after merging a branch

Actions running after merging a branch have warnings:

```txt
[**Detect changed packages**](https://github.com/unic/unic-agents-plugins/actions/runs/25256449326/job/74056537707#step:7:6)
