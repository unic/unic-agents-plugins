...
*Source spec*: `apps/claude-code/unic-archon-dlc/docs/plans/00-setup-slash-command.md`
*ADR*: `apps/claude-code/unic-archon-dlc/docs/adr/0001-setup-as-slash-command.md`
