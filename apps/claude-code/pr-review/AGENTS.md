...
- **Four-state Review Thread classification.** Each existing Review Thread is classified into one of four states (`addressed`, `unaddressed`, `outdated`, `new-finding`) before any write. See [ADR-0005](docs/adr/0005-four-state-thread-classification.md).
