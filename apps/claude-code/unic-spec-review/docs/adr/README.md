...
> Status: these ADRs record decisions locked during the design grilling for the [PRD](../issues/unic-spec-review/PRD.md). The plugin is scaffolding; the decisions are made, the implementation is pending.
