...
- Does this belong as an Archon _workflow_ at all, or only a Claude Code _skill/command_? (Matt's is a skill; Archon workflows run in worktrees, which a conversation-compaction step doesn't need.) Decide and record.
