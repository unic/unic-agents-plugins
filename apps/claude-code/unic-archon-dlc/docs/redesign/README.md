...
| 05  | `/tickets`              | skill       | ✅ done | command; stops at build-ready `issues.json` (no DAG gen); `tickets` config; ADR-0022 (PR #TBD) |
| 06  | `/build`                | Archon      | ▶️ next | keystone — anti-cheat red/green; consumes `issues.json` via generic loop (ADR-0022)            |
