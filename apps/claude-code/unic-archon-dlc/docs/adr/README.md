...
- `Accepted (YYYY-MM-DD, revised YYYY-MM-DD)` — inline revision. The index column carries this one in full, both dates, because a revision date a reader cannot see in the index is a revision they will not look for. ADR-0020 is the first row in this form.
...
| 0020 | `/specs` reaches an aligned PRD by branch-on-input                                         | Accepted (2026-07-02, revised 2026-09-02)                 |
...
| 0025 | `/qa` is an Archon pipeline with two config-gated approvals + an issue-producing on-ramp   | Accepted (2026-07-02, revised 2026-09-04; #389 folded in) |
