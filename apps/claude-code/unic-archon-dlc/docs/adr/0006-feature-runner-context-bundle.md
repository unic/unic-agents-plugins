# 0006. Feature Runner injects a scoped context bundle into every `/tdd` sub-agent invocation

**Status:** Superseded by [ADR-0010](0010-retire-implement-feature-skill.md) (2026-05)

Renumbered from monorepo-root ADR-0027 (2026-05).
...
1. **Issue file** — `## What to build` and `## Acceptance criteria` serve as the pre-answered planning conversation (see ADR-0008).
