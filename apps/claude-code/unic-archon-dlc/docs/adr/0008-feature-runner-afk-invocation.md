# 0008. Feature Runner invokes `/tdd` non-interactively; issue acceptance criteria replace the planning phase

**Status:** Superseded by [ADR-0010](0010-retire-implement-feature-skill.md) (2026-05)

Renumbered from monorepo-root ADR-0029 (2026-05).
...
- **Non-interactive Agent tool invocation with injected context bundle** — chosen. No skill modifications required; the planning information is supplied via the context bundle (ADR-0006) rather than elicited at runtime.
