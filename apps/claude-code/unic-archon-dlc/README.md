...
| `build.coverage_threshold`                               | `null`                 | number (0–100) or `null`                      | Minimum % coverage. `null` no longer skips: `coverage-gate` has nothing to judge a figure against, so it reports `unresolved`                                                         |
