...
**Implementation status**: comments gate live as of v2.1.4 (PR #226, issue #213); errors gate live as of v2.1.6 (issue #214); types gate (#215 — additive JSDoc type constructs in non-`.ts` source files, per the table above) is a planned follow-up.
