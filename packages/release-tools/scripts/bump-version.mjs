...
import { gitCmd, isWindows, pnpmBin } from './lib/platform.mjs'
...
try {
	...
	const [gitExe, ...statusArgs] = gitCmd(['status', '--porcelain'])
	const statusResult = spawnSync(gitExe, statusArgs, { encoding: 'utf8' })
